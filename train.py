...
## define global variables (move to global constants.py script)
...
class DiscreteSynthMatchingEnv(py_environment.PyEnvironment):
    ...
    def __init__(self, N_synth_params, 
        ...
        for feat in features_reward:
            if feat == 'loudness':
                features_rew += loudness_feature_names
            elif feat == 'mfcc':
                features_rew += mfcc_feature_names
            elif feat == 'chroma':
                features_rew += chroma_feature_names
            elif feat == 'specshape':
                features_rew += specshape_feature_names
            elif feat == 'sinefeaturefreqs':
                features_rew += sinefeaturefreqs_feature_names
            elif feat == 'sinefeaturemags':
                features_rew += sinefeaturemags_feature_names
            else:
                features_rew.append(feat)
        
        # compute reward weights based on user settings
        features_rew = [feat for feat in feature_names if feat in features_rew]
        reward_weights = []
...
if __name__ == '__main__':
    ...
    environment = DiscreteSynthMatchingEnv(N_synth_params, 
                                         features_keep,
                                         features_reward,
                                         synth_name, 
                                         corpus_name,
